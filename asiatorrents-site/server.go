...
func RunServer(session *mgo.Session) {
	// create logger
	...
	http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		...
		i := fstopinfo.NewInfo(logger, csession)
		...
		if cat == "" {
			...
			d, err = i.TopCategory("weekly", cat)
		}
		if err != nil {
		...
		err = tmpl.ExecuteTemplate(w, "index", template.HTML(body.String()))
		if err != nil {
